...
% TODO: Werktitel
\title{Competentie framework PL1 / CICS developer op z/OS level 1 definiëren en uitwerken met PoC binnen onderwijscontext.}
...
\keywords{PL1, CICS, Competentie Framework}
...
Een van de belangrijkste manieren om dit te voorkomen is het opleiden van nieuw mainframe talent.
...
Op basis van deze requirements wordt een framework opgesteld en hieruit ga ik aan het werk om een praktische learningsite te ontwikkelen.
