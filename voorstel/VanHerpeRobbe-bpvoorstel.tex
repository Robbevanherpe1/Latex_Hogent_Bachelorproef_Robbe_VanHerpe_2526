...
\begin{abstract}
  ...
  Het abstract is als volgt opgebouwd: 
° inleiding tot het algemene thema en de uitdaging daarbinnen
° concrete schets van het specifieke probleem (probleem expliciet benoemen)
° hoofdonderzoeksvraag
° algemene beschrijving van de voorgestelde methodologie (2-3 zinnen)
° verwachte (geen verzonnen!) resultaten 
° verwachte conclusie (indien de verwachte resultaten bevestigd worden door het onderzoek)
\end{abstract}
