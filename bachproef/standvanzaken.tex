...
Een mainframe kan worden omschreven als een enorm sterke computer, maar tot in tegenstelling van andere servers is zijn doel heel specifiek.
...
\subsection{Mainframe security}%
\label{sec:security-mainframe}
...
\subsection{Mainframe virtualisatie}%
\label{sec:Securable-mainframe}
